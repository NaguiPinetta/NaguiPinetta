...
- **Doc systems at scale** (standards, templates, IA, governance)
...
End-to-end system that scans and reconstructs large Aha! Knowledge Bases, builds a RAG pipeline (pgvector), enables a grounded Copilot, and automates work requests/comments back into Aha.  
→ Case study: **(add your portfolio link here later)**

### Omniglot — Translation / Localization Wrapper + Job Pipeline
A practical platform for batch translation of UI microcopy and documentation using model selection, glossaries/style rules, and structured jobs.  
→ Case study: **(add your portfolio link here later)**

### AI Tunes — Local Fine-Tuning & Evaluation Lab
Tooling for dataset creation, training adapters (LoRA), and evaluation workflows for local models — built to test behavior, consistency, and automation scenarios.  
→ Case study: **(add your portfolio link here later)**

## Selected repos
- `jdp-portfolio-2025` — portfolio site (SvelteKit + MDsveX)
- `eurekapp` — KB automation + RAG platform
- `omniglot-wrapper` — localization/translation system
- `aitunes` — training + eval workflows
